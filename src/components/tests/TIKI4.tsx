          ...
          <div style={{ textAlign: 'left', background: '#f8fbff', padding: '25px', borderRadius: '12px', borderLeft: '6px solid #3498db', marginBottom: '35px', lineHeight: '1.7', color: '#444', fontSize: '16px' }}>
            ...
            <div style={{ background: '#fff', padding: '20px', borderRadius: '12px', border: '1px solid #ddd', marginTop: '20px' }}>
              ...
              <div style={{ marginBottom: '20px' }}>
                <img src="/soal/tiki4/contoh/contoh_1.jpeg" alt="Contoh 1" style={{ maxWidth: '100%', borderRadius: '8px', border: '1px solid #eee' }} />
                <p style={{ margin: '10px 0 0 0', color: '#2980b9', fontWeight: 'bold' }}>CONTOH 1 : Pilihlah jawaban dalam gambar yaitu B dan D</p>
              </div>

              <div style={{ marginBottom: '20px' }}>
                <img src="/soal/tiki4/contoh/contoh_2.jpeg" alt="Contoh 2" style={{ maxWidth: '100%', borderRadius: '8px', border: '1px solid #eee' }} />
                <p style={{ margin: '10px 0 0 0', color: '#2980b9', fontWeight: 'bold' }}>CONTOH 2 : Pilihlah jawaban dalam gambar yaitu B dan C</p>
              </div>
            </div>
          </div>
          <button 
        ...
        <div style={{ width: '300px', flexShrink: 0, background: 'white', padding: '25px', borderRadius: '12px', boxShadow: '0 10px 25px rgba(0,0,0,0.05)', position: 'sticky', top: '30px' }}>
          ...
          <div style={{ marginTop: '25px', fontSize: '14px', color: '#666', borderTop: '2px solid #eaeaea', paddingTop: '15px' }}>
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
              ...
              <span>Sudah Dijawab ({Object.keys(answers).filter(k => (answers[parseInt(k)] || []).length > 0).length})</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <div style={{ width: '16px', height: '16px', background: '#fff', border: '1px solid #ccc', borderRadius: '4px', marginRight: '10px' }}></div> 
              <span>Belum Dijawab ({questions.length - Object.keys(answers).filter(k => (answers[parseInt(k)] || []).length > 0).length})</span>
            </div>
          </div>
        </div>
      </div>
