...
with open("scripts/msdt_raw.txt", "r", encoding="utf-8") as f:
    text = f.read()
...
for line in lines:
    ...
    if re.match(r'^A\)', line):
        ...
        questions.append({
            ...
            "content": "Pilih satu pernyataan yang PALING MENGGAMBARKAN DIRI ANDA.",
...
with open("scripts/msdt_parsed.json", "w", encoding="utf-8") as out:
